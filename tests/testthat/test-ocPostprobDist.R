...
test_that("two ocPostprobDist calls that differ in parE does not give the same result.", {
  ...
  set.seed(198)
  expect_warning(
    result_uniform_hard_coded <- ocPostprobDist(
      nnE = input$nnE,
      truep = input$truep,
      deltaE = input$deltaE,
      deltaF = input$deltaF,
  ...
  set.seed(198)
  expect_warning(
    result_no_hard_code <- ocPostprobDist(
      nnE = input$nnE,
      truep = input$truep,
      deltaE = input$deltaE,
      deltaF = input$deltaF,
