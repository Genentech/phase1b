...
of variables by defining the following random variables $Z$ and $W$ such that $Z=X-Y$
...
# c(5.75,4.25)        #Prior of the Phase 1b trial
# c(75,75)            #Posterior of the control
xx <- seq(0, 1, .001)
dens.control <- dbeta(xx, 75, 75)
dens.prior <- dbeta(xx, 5.75, 4.25)
...
# c(5.75,4.25)        #Prior of the Phase 1b trial
# c(75,75)            #Posterior of the control
# 80                  #Sample size of the 1b trial
# 55                  #Number of responders
...
set.seed(4)
results <- ocPostprob(
  nn = c(10, 20, 30), p = 0.4, p0 = 0.2, p1 = 0.3, tL = 0.6,
  tU = 0.8, parE = c(1, 1), ns = 10000
)
results$oc
```
...
use predictive proabilities (*PP*) to conduct interim analyses allowing gray
