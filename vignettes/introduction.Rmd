...
author:
  - name: Audrey Yeo
    email: audrey@finc-research.com
...
following command:
```{r install-phase1b-from-github, eval=FALSE}
library(devtools)
devtools::install_github("https://github.com/Genentech/phase1b")
```
...
```{r, echo = FALSE}
ex1_plotBetaDiff_cap <- paste(
  "The distribution of the difference in PET-CR rates between the novel",
...
```{r ex1:betadiff1:plotBetaDiff, echo=TRUE, fig.cap = ex1_plotBetaDiff_cap}
plotBetaDiff(
  parX = parX,
  parY = parY,
  go_cut = 0.3,
