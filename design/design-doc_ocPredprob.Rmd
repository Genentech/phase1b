...
```{r cars}
new_ocPredprob <- function(nnE, truep, p0, p1, tT, tF, phiL = 1 - phiFu, phiU, phiFu = 1 - phiL, parE = c(1, 1),
...
# > result
#      ExpectedN PrStopEarly PrEarlyEff PrEarlyFut PrEfficacy PrFutility PrGrayZone
# [1,]      13.2        0.96       0.94       0.02       0.96       0.04          0
# > expected
#   ExpectedN PrStopEarly PrEarlyEff PrEarlyFut PrEfficacy PrFutility PrGrayZone
# 1        10           1       0.64       0.06       0.64       0.06        0.3
```
