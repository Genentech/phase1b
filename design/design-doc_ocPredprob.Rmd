...
```{r}
h_get_decision_two_predprob <- function(nnr, truep, p0, p1, parE = c(1, 1), nnE, nnF, tL, tU, tT, weights, qU, phiFu) {
  index_look <- 1
  assert_numeric(nnr)
  size_look <- nnr[index_look]
  all_sizes <- decision <- NA
...
```{r}
h_get_decision_two_predprob(nnr = c(10, 20),
                            truep = 0.3,
                            p0 = 0.2,
                            p1 = 0.3,
                            parE = c(1,1),
                            ...
                            weights = 1,
                            phiFu = 0.4)
# h_get_decision_two_predprob(nnr = c(10, 20), truep = 0.3, p0 = 0.2, p1 = 0.3, parE = c(1, 1), nnE = c(10, 20), nnE = c(10, 20), tL = 0.90, tU = 0.60, weights = 1)
```
