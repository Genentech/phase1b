...
Translation:
* Decision 1 says:
    * Final GO = P(truep > p0 | data) => tT, by the way P(truep > p0) > tT = qU
    when the prob of good response is high enough, then we have a successful trial
    * Final STOP = P(truep > p0 | data ) < tT =  Unsuccessful trial if not successful 
...
```{r, echo = FALSE}
set.seed(2024)
tt <- list(nnE = c(10, 20, 30) , nnF = c(10, 20, 30), truep = 0.4, p0 = 0.25, p1 = 0.30, tT = 0.6, tF = 0.5, tFu = 0.6,
